...
{
    [TestFixture]
    public class NoRegexStringCalculatorIntegrationTests
    {
        private readonly StringCalculator _stringCalculator = new StringCalculator(new RegexFreeDelimiterParser(new[] {",", "\n"}), new Adder());
